...
CHALLENGE_PROMPTS = [
    "Your price estimate seems slightly off. Are you sure about your approach? Please generate your output again reflecting any change if you think it is necessary.",
    
    "Have you considered factors like the rarity of this NFT and recent transaction history? What would your output be if you take these into account?",
    ...
    "The sales history you cite may not be representative of the current market. What if recent transactions are outliers rather than indicators of a trend? Would your approach still be accurate?",
